...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.add_new_tab(QUrl('https://github.com/spyder-ide/Spyder-Workshop/blob/master/README.md'), 'Spyder Workshop')
    ...
    def navigate_home(self):
        self.tabs.currentWidget().setUrl(QUrl("https://github.com/spyder-ide/Spyder-Workshop/blob/master/README.md"))
